...
const getPasswords = (object) => {
  ...
  <tr>
    ...
    <td class="edit-td"><input type="submit" value="Edit" form="password-edit" id="edit-button"></td>
    <td class="delete-td"><input type="submit" value="Delete" form="password-delete" id="delete-button"></td>
  </tr>
  `;
  return password;
};
