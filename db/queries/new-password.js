...
const postPassword = (object, user_id) => {
  ...
  RETURNING *;`,
  [user_id, object.organization_id, object.role_id, object.is_user_created, object.website, object.username, object.password, object.hint, object.category, object.require_master_password])
    .then(data => {
      return data.rows
    });
};
